...
### Hands-On: Smart Actions Workflow
...
- **Use in Edit Mode**: Smart actions work seamlessly with collaborative editing
...
**SQL-Specific Instructions (`.github/copilot-sql.md`)**:
